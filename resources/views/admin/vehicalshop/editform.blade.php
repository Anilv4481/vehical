...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
            <select class="form-control form-control-solid" name="vehical_shop_status">
              ...
              <option value="0" {{ $vehicalshop->vehical_shop_status == 0 ?  'selected':'' }} >Approve</option>
              <option value="1" {{ $vehicalshop->vehical_shop_status == 1 ?  'selected':'' }} >Reapprove</option>
              <option value="2" {{ $vehicalshop->vehical_shop_status == 2 ?  'selected':'' }} >Pending</option>
            </select>
        </div>
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
                {!! Form::text('vehical_desc', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.vehical_desc', 1)]) !!}
        </div>
