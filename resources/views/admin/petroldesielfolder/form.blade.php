...
<div class="card-body">
    ...
    <div class="row mb-6">
       ...
       <div class="col-lg-4 fv-row">
        ...
        <div class="col-lg-4 fv-row">
                {!! Form::text('vehical_no', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.vehical_number', 1)]) !!}
        </div>
    ...
    <div class="row mb-6">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ trans_choice('content.fuel_type', 1) }}</label>
    ...
    <div class="row mb-6">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ trans_choice('content.quanity_fuel', 1) }}</label>

        <div class="col-lg-4 fv-row">
            <select class="form-control form-control-solid" name="quanity_fuel">
              <option value="">Select Quantity Fuel</option>
              <option value="5leater">5 Leater</option>
              <option value="10leater">10 Leater</option>
              <option value="15leater">15 Leater</option>
              <option value="20leater">20 Leater</option>
    ...
    <div class="row mb-6">
        ...
        <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ trans_choice('content.descrpition', 1) }}</label>

        <div class="col-lg-4 fv-row">
                {!! Form::text('descrpition', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.des', 1)]) !!}
        </div>
    </div>
